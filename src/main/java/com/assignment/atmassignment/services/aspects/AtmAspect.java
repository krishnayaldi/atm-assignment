package com.assignment.atmassignment.services.aspects;
...
/**
 * This class defines an aspect where logging is performed at starting of method
 * as well as when it completes its execution. Also prints the total time took
...
public class AtmAspect {
	...
	Logger logger = LoggerFactory.getLogger(AtmAspect.class);
